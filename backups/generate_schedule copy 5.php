...
include __DIR__ . '/detect_conflict.php';
...
$conflictResult = detect_conflicts($rows);

if ($conflictResult['has_conflict']) {
    file_put_contents(
        __DIR__ . '/conflicts.json',
        json_encode($conflictResult, JSON_PRETTY_PRINT)
    );

    die("❌ Conflicts detected. See conflicts.json for details.");
}
