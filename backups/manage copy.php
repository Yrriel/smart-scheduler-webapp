        ...
        <form method="post" action="add_faculty.php">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="total_units" placeholder="e.g.,10">
                </div>
        ...
        <!-- <div class="modal-backdrop hidden" id="editFacultyModal">
            <div class="modal">
                ...
                <form method="post" action="update_faculty.php" id="editFacultyForm">
                    ...
                    <div class="form-group">
                        <label>Faculty Name</label>
                        <input type="text" name="faculty_name" id="edit_faculty_name" placeholder="e.g., Juan Dela Cruz">
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label>Employment Type</label>
                            <input type="text" name="employment_type" id="edit_employment_type" placeholder="e.g., Full-Time">
                        </div>
                        <div class="form-group">
                            <label>Current Status</label>
                            <input type="text" name="current_status" id="edit_current_status" placeholder="e.g., Active">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>Total Units</label>
                            <input type="text" name="total_units" id="edit_total_units" readonly>
                        </div>
                        <div class="form-group">
                            <label>Total Hours per Week</label>
                            <input type="text" name="total_hours_per_week" id="edit_total_hours" placeholder="e.g., 18">
                        </div>
                    </div>
        ...
        <!-- <div class="modal-backdrop hidden" id="editFacultyModal">
            <div class="modal">
                <div class="modal-header">
                    ...
                    <form method="post" action="update_course.php" id="editFacultyForm">
                        <input type="hidden" name="id" id="edit_course_id">
        ...
        <!-- <div class="modal-backdrop hidden" id="editFacultyModal">
            <div class="modal">
                <div class="modal-header">
                    ...
                    <form method="post" action="update_faculty.php" id="editFacultyModal">
                        <input type="hidden" name="id" id="edit_faculty_id">
