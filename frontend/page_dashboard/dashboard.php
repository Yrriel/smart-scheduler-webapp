...
<div class="container">
    ...
    <div class="dashboard-panel">
        ...
        <div class="panel-row">
            ...
            <span><?= $labCount ?> Subjects</span>
        </div>

        <div class="panel-row">
            <span>Lecture Subjects</span>
            <span><?= $lectureCount ?> Subjects</span>
        </div>
    ...
    <div class="dashboard-panel">
        ...
        <p class="panel-subtitle">Average teaching hours per faculty</p>

        <div class="panel-row">
            <span>Full-time Faculty</span>
            <span>30 Hours / Week (Avg)</span>
        </div>

        <div class="panel-row">
            <span>Part-time Faculty</span>
            <span>2–12 Hours / Week</span>
        </div>
    </div>
