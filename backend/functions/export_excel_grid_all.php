...
$data = json_decode(
    file_get_contents(__DIR__ . 'edit-output.json'),
    true
);
...
$views = ['day', 'faculty', 'section', 'room'];
...
foreach ($views as $view) {
    ...
    $sheet->getStyle("A2:A" . max($rowMap))->applyFromArray([
        'font' => ['bold' => true],
        'alignment' => [
            'horizontal' => Alignment::HORIZONTAL_CENTER,
            'vertical' => Alignment::VERTICAL_CENTER,
    ...
    $sheet->getStyle("A1:$lastCol" . max($rowMap))
